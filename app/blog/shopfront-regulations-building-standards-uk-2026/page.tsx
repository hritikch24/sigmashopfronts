    ...
    <>
      ...
      <article className="section-padding bg-obsidian-light">
        <div className="container-max max-w-3xl">
          ...
          <h2 className="font-heading text-2xl font-semibold text-white mt-10 mb-4">Part L: Thermal Performance (Conservation of Fuel and Power)</h2>
          ...
          <h2 className="font-heading text-2xl font-semibold text-white mt-10 mb-4">Part M: Access to and Use of Buildings (DDA Compliance)</h2>
          <p className="text-charcoal leading-relaxed mb-4">
          ...
          <h2 className="font-heading text-2xl font-semibold text-white mt-10 mb-4">Part B: Fire Safety</h2>
          <p className="text-charcoal leading-relaxed mb-4">
          ...
          <h2 className="font-heading text-2xl font-semibold text-white mt-10 mb-4">Planning Permission</h2>
          <p className="text-charcoal leading-relaxed mb-4">
          ...
          <h2 className="font-heading text-2xl font-semibold text-white mt-10 mb-4">Conservation Areas: Additional Considerations</h2>
          <p className="text-charcoal leading-relaxed mb-4">
          ...
          <h2 className="font-heading text-2xl font-semibold text-white mt-10 mb-4">BS EN 16005: Safety of Automatic Doors</h2>
          <p className="text-charcoal leading-relaxed mb-4">
          ...
          <h2 className="font-heading text-2xl font-semibold text-white mt-10 mb-4">How Sigma Shop Fronts Ensures Compliance</h2>
          <p className="text-charcoal leading-relaxed mb-6">
