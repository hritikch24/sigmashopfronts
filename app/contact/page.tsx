          ...
          <div className="grid lg:grid-cols-[1fr_420px] gap-12 items-start">
            ...
            <aside className="space-y-6">
              ...
              <div className="rounded-xl overflow-hidden border border-grey-200">
                <iframe
                  src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2430.5!2d-2.0150!3d52.4912!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x4870942b1e5e4b01%3A0x5678!2s4+Thornwood+Close%2C+Oldbury+B68+9LX!5e0!3m2!1sen!2suk!4v1"
                  width="100%"
                  height="200"
                  style={{ border: 0 }}
                  allowFullScreen
                  ...
                  title="Sigma Shop Fronts location on Google Maps"
                />
              </div>
