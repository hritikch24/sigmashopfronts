      ...
      <div className="container-max">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="prose-content space-y-10 text-grey-700 leading-relaxed">
            ...
            <section>
              <p>
                These Terms and Conditions (&ldquo;Terms&rdquo;) govern all quotations, orders, and contracts entered into by <strong className="text-white">Sigma Shopfronts and Shutter Limited</strong> (Company No: 16794487), registered in England and Wales (<strong className="text-white">&ldquo;the Company&rdquo;, &ldquo;we&rdquo;, &ldquo;us&rdquo;</strong>) with our customers (&ldquo;you&rdquo;). Please read them carefully before engaging our services.
              </p>
              <p className="mt-4">
